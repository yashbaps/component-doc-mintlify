---
title: "Baseline"
description: "Guidelines for 'must have' properties of component"
icon: "check"
---
...
4. **Compile-time errors for missing implementations.**
   ...
   - Example:
     ...
     class Country with KSelectable<Country> { //<----- Must gives compile time error. Developer must override respective fields.
       final int id;
       final String name;
